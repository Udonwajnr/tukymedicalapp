    ...
    <>
        <div className="flex items-center justify-around ">
            ...
            <div className="relative">              
                ...
                <div className="absolute shadow-2xl top-[290px] -left-24 bg-white rounded-2xl px-3 py-3 shadow-5xl">
                    <p className="text-center text-sm ">The number one service that <br />renders quick healthcare in Nigeria</p>
                </div>
                <div className="absolute top-[200px] -right-6  bg-white px-3 py-3 rounded-2xl shadow-5xl">
